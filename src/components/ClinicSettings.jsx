...
import { Settings, CheckCircle2, AlertCircle, Building2, Phone, User, Clock, Users, CalendarCheck, Sliders, DollarSign, Printer, Image, Palette } from 'lucide-react';
...
export default function ClinicSettings({ onUpdateClinicInfo, currentUser, onLogout, lang = 'fr', currentTheme = 'dark-emerald', onThemeChange }) {
  ...
  const sections = [
    ...
    { id: 'theme', label: lang === 'fr' ? 'Thèmes & Apparence' : 'Themes & Appearance', icon: Palette },
